...
<?php
	...
	{
		echo'
			<li class="li"><a href="admin_home.php">Controls</a></li>
			<li class="li"><a href="add_class.php"> On/Off</a></li>
			<li class="li"><a href="add_sub.php"> with edex</a></li>

			<li class="li"><a href="add_staff.php"> manual Setting</a></li>
			<li class="li"><a href="view_staff.php">about</a></li>
